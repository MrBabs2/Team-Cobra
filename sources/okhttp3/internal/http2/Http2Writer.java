...
public final class Http2Writer implements Closeable {
    ...
    private final C12905f hpackBuffer;
    private final Hpack.Writer hpackWriter;
    private int maxFrameSize = Http2.INITIAL_MAX_FRAME_SIZE;
    private final C12909g sink;

    @C4789l(mo16639bv = {1, 0, 3}, mo16640d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo16641d2 = {"Lokhttp3/internal/http2/Http2Writer$Companion;", "", "()V", "logger", "Ljava/util/logging/Logger;", "kotlin.jvm.PlatformType", "okhttp"}, mo16642k = 1, mo16643mv = {1, 1, 15})
    /* compiled from: Http2Writer.kt */
    ...
    public Http2Writer(C12909g gVar, boolean z) {
        C10202j.m34178b(gVar, "sink");
        this.sink = gVar;
        this.client = z;
        C12905f fVar = new C12905f();
        this.hpackBuffer = fVar;
        this.hpackWriter = new Hpack.Writer(0, false, fVar, 3, (DefaultConstructorMarker) null);
    }
    ...
    public final synchronized void applyAndAckSettings(Settings settings) throws IOException {
        C10202j.m34178b(settings, "peerSettings");
        if (!this.closed) {
    ...
    public final synchronized void connectionPreface() throws IOException {
        if (this.closed) {
            ...
            if (logger.isLoggable(Level.FINE)) {
                ...
                logger2.fine(Util.format(">> CONNECTION " + Http2.CONNECTION_PREFACE.mo41234m(), new Object[0]));
            }
            this.sink.mo41161c(Http2.CONNECTION_PREFACE);
            this.sink.flush();
        }
    }

    public final synchronized void data(boolean z, int i, C12905f fVar, int i2) throws IOException {
        if (!this.closed) {
            int i3 = 0;
            if (z) {
                i3 = 1;
    ...
    public final void dataFrame(int i, int i2, C12905f fVar, int i3) throws IOException {
    ...
    public final synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
        ...
        C10202j.m34178b(bArr, "debugData");
        if (!this.closed) {
            boolean z = false;
