...
@C4789l(mo16639bv = {1, 0, 3}, mo16640d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\t\bÆ\u0002\u0018\u00002\u00020\u0001:\u0002\u0018\u0019B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0015\u001a\u00020\u00052\u0006\u0010\u0016\u001a\u00020\u0005J\u0014\u0010\u0017\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004H\u0002R\u001d\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\t\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u0019\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00110\u0010¢\u0006\n\n\u0002\u0010\u0014\u001a\u0004\b\u0012\u0010\u0013¨\u0006\u001a"}, mo16641d2 = {"Lokhttp3/internal/http2/Hpack;", "", "()V", "NAME_TO_FIRST_INDEX", "", "Lokio/ByteString;", "", "getNAME_TO_FIRST_INDEX", "()Ljava/util/Map;", "PREFIX_4_BITS", "PREFIX_5_BITS", "PREFIX_6_BITS", "PREFIX_7_BITS", "SETTINGS_HEADER_TABLE_SIZE", "SETTINGS_HEADER_TABLE_SIZE_LIMIT", "STATIC_HEADER_TABLE", "", "Lokhttp3/internal/http2/Header;", "getSTATIC_HEADER_TABLE", "()[Lokhttp3/internal/http2/Header;", "[Lokhttp3/internal/http2/Header;", "checkLowercase", "name", "nameToFirstIndex", "Reader", "Writer", "okhttp"}, mo16642k = 1, mo16643mv = {1, 1, 15})
/* compiled from: Hpack.kt */
public final class Hpack {
    public static final Hpack INSTANCE;
    private static final Map<C12911i, Integer> NAME_TO_FIRST_INDEX;
    ...
    private final Map<C12911i, Integer> nameToFirstIndex() {
        ...
        Map<C12911i, Integer> unmodifiableMap = Collections.unmodifiableMap(linkedHashMap);
        C10202j.m34174a((Object) unmodifiableMap, "Collections.unmodifiableMap(result)");
        return unmodifiableMap;
    }

    public final C12911i checkLowercase(C12911i iVar) throws IOException {
        C10202j.m34178b(iVar, "name");
        int s = iVar.mo41239s();
        for (int i = 0; i < s; i++) {
            byte b = (byte) 65;
            byte b2 = (byte) 90;
            byte a = iVar.mo41216a(i);
            if (b <= a && b2 >= a) {
                throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + iVar.mo41242v());
            }
        }
        return iVar;
    }

    public final Map<C12911i, Integer> getNAME_TO_FIRST_INDEX() {
    ...
    public static final class Reader {
        ...
        public Reader(C12892a0 a0Var, int i) {
            this(a0Var, i, 0, 4, (DefaultConstructorMarker) null);
        }

        public Reader(C12892a0 a0Var, int i, int i2) {
            C10202j.m34178b(a0Var, "source");
            this.headerTableSizeSetting = i;
            this.maxDynamicTableByteCount = i2;
            this.headerList = new ArrayList();
            this.source = C12919p.m41675a(a0Var);
        ...
        private final void clearDynamicTable() {
            C10516j.m35591a((Object[]) this.dynamicTable, (Object) null, 0, 0, 6, (Object) null);
        ...
        private final C12911i getName(int i) throws IOException {
            if (isStaticHeader(i)) {
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> n = C10539w.m35815n(this.headerList);
        ...
        public final C12911i readByteString() throws IOException {
            int readByte = readByte();
            boolean z = (readByte & 128) == 128;
            long readInt = (long) readInt(readByte, 127);
            if (!z) {
                return this.source.mo41148a(readInt);
            }
            C12905f fVar = new C12905f();
            Huffman.INSTANCE.decode(this.source, readInt, fVar);
            return fVar.mo41179k();
        }

        public final void readHeaders() throws IOException {
            while (!this.source.mo41169g()) {
    ...
    public static final class Writer {
        ...
        private int nextHeaderIndex;
        private final C12905f out;
        private int smallestHeaderTableSizeSetting;
        private final boolean useCompression;

        public Writer(int i, C12905f fVar) {
            this(i, false, fVar, 2, (DefaultConstructorMarker) null);
        }

        public Writer(int i, boolean z, C12905f fVar) {
        ...
        public Writer(C12905f fVar) {
            this(0, false, fVar, 3, (DefaultConstructorMarker) null);
        }
        ...
        public final void writeByteString(C12911i iVar) throws IOException {
            C10202j.m34178b(iVar, "data");
            if (!this.useCompression || Huffman.INSTANCE.encodedLength(iVar) >= iVar.mo41239s()) {
                writeInt(iVar.mo41239s(), 127, 0);
                this.out.mo41161c(iVar);
                return;
            }
            C12905f fVar = new C12905f();
            Huffman.INSTANCE.encode(iVar, fVar);
            C12911i k = fVar.mo41179k();
            writeInt(k.mo41239s(), 127, 128);
            this.out.mo41161c(k);
        }
        ...
        public final void writeHeaders(List<Header> list) throws IOException {
            int i;
            int i2;
            C10202j.m34178b(list, "headerBlock");
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                C12911i t = header.name.mo41240t();
                C12911i iVar = header.value;
                Integer num = Hpack.INSTANCE.getNAME_TO_FIRST_INDEX().get(t);
                if (num != null) {
                    i2 = num.intValue() + 1;
                    if (2 <= i2 && 7 >= i2) {
                        if (C10202j.m34176a((Object) Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i2 - 1].value, (Object) iVar)) {
                            i = i2;
                        } else if (C10202j.m34176a((Object) Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i2].value, (Object) iVar)) {
                            i = i2;
                            i2++;
                        }
                    }
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        if (header2 != null) {
                            if (C10202j.m34176a((Object) header2.name, (Object) t)) {
                                Header header3 = this.dynamicTable[i5];
                                if (header3 == null) {
                                    C10202j.m34172a();
                                    throw null;
                                } else if (C10202j.m34176a((Object) header3.value, (Object) iVar)) {
                ...
                } else if (!t.mo41225b(Header.PSEUDO_PREFIX) || !(!C10202j.m34176a((Object) Header.TARGET_AUTHORITY, (Object) t))) {
                    writeInt(i, 63, 64);
                    writeByteString(iVar);
                    insertIntoDynamicTable(header);
                } else {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        public /* synthetic */ Writer(int i, boolean z, C12905f fVar, int i2, DefaultConstructorMarker defaultConstructorMarker) {
