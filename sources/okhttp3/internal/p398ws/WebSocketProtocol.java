...
public final class WebSocketProtocol {
    ...
    public final String acceptHeader(String str) {
        ...
        return aVar.mo41249c(str + ACCEPT_MAGIC).mo41237q().mo41218a();
    }
    ...
    public final void toggleMask(C12905f.C12907b bVar, byte[] bArr) {
        C10202j.m34178b(bVar, "cursor");
        C10202j.m34178b(bArr, RoomNotification.KEY);
        int length = bArr.length;
        int i = 0;
        do {
            byte[] bArr2 = bVar.f33154j;
            int i2 = bVar.f33155k;
            int i3 = bVar.f33156l;
            if (bArr2 != null) {
                while (i2 < i3) {
