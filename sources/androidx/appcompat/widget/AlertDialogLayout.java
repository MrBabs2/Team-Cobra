...
public class AlertDialogLayout extends C0229c0 {
    public AlertDialogLayout(Context context) {
        super(context);
    }

    /* renamed from: a */
    private void m884a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private void m886c(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0229c0.C0230a aVar = (C0229c0.C0230a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: d */
    private boolean m887d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C4795f.topPanel) {
                    view = childAt;
                } else if (id == C4795f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C4795f.contentPanel && id != C4795f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.c0$a r15 = (androidx.appcompat.widget.C0229c0.C0230a) r15
            int r2 = r15.f1007b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p050l.p075h.p084l.C5071v.m9204p(r17)
            int r2 = p050l.p075h.p084l.C5019d.m8933a(r2, r3)
            r2 = r2 & 7
            r3 = 1
    ...
    /* renamed from: c */
    private static int m885c(View view) {
        int q = C5071v.m9205q(view);
        if (q > 0) {
            return q;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m885c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
