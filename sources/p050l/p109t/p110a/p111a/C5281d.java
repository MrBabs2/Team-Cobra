...
/* renamed from: l.t.a.a.d */
/* compiled from: AnimationUtilsCompat */
public class C5281d {
    /* renamed from: a */
    public static Interpolator m9940a(Context context, int i) throws Resources.NotFoundException {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m9941a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
    ...
    /* renamed from: a */
    private static Interpolator m9941a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Interpolator gVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            gVar = new C5285g(context, asAttributeSet, xmlPullParser);
                        } else {
