...
/* renamed from: cm.aptoide.pt.view.fragment.BaseBottomSheetDialogView */
public class BaseBottomSheetDialogView extends BaseBottomSheetDialogFragment implements View {
    ...
    static /* synthetic */ class C46261 {
        ...
        static {
            ...
            L_0x001d:
                ...
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.DETACH     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.DESTROY     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x003e }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.CREATE_VIEW     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.START     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.RESUME     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r2 = 7
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x0060 }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.PAUSE     // Catch:{ NoSuchFieldError -> 0x0060 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0060 }
                r2 = 8
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0060 }
            L_0x0060:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x006c }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.STOP     // Catch:{ NoSuchFieldError -> 0x006c }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x006c }
                r2 = 9
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x006c }
            L_0x006c:
                int[] r0 = $SwitchMap$com$trello$rxlifecycle$android$FragmentEvent     // Catch:{ NoSuchFieldError -> 0x0078 }
                com.trello.rxlifecycle.g.b r1 = com.trello.rxlifecycle.p209g.C9008b.DESTROY_VIEW     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015cm.aptoide.p016pt.view.fragment.BaseBottomSheetDialogView.C46261.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public C5368e<View.LifecycleEvent> convertToEvent(C9008b bVar) {
        switch (C46261.$SwitchMap$com$trello$rxlifecycle$android$FragmentEvent[bVar.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public C5368e<View.LifecycleEvent> getLifecycleEvent() {
        return lifecycle().mo18687f(new C4630a(this));
    }
}
