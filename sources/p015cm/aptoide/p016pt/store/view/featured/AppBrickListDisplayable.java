...
public class AppBrickListDisplayable extends DisplayablePojo<App> {
    ...
    public int getViewLayout() {
        return C1086R.layout.brick_app_item_list;
    }

    public AppBrickListDisplayable(App app, String str, NavigationTracker navigationTracker2, StoreContext storeContext2) {
        super(app);
        this.tag = str;
