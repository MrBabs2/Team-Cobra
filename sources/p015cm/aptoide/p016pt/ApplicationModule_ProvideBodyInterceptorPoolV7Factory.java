...
/* renamed from: cm.aptoide.pt.ApplicationModule_ProvideBodyInterceptorPoolV7Factory */
public final class ApplicationModule_ProvideBodyInterceptorPoolV7Factory implements C10824b<BodyInterceptor<BaseBody>> {
    ...
    public static BodyInterceptor<BaseBody> provideBodyInterceptorPoolV7(ApplicationModule applicationModule, AuthenticationPersistence authenticationPersistence, IdsRepository idsRepository, SharedPreferences sharedPreferences, Resources resources, QManager qManager, String str, AptoideMd5Manager aptoideMd5Manager) {
        BodyInterceptor<BaseBody> provideBodyInterceptorPoolV7 = applicationModule.provideBodyInterceptorPoolV7(authenticationPersistence, idsRepository, sharedPreferences, resources, qManager, str, aptoideMd5Manager);
        C10825c.m36718a(provideBodyInterceptorPoolV7, "Cannot return null from a non-@Nullable @Provides method");
        return provideBodyInterceptorPoolV7;
    }
