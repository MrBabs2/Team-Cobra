...
/* renamed from: cm.aptoide.pt.feature.NewFeatureDialogPresenter$handleTurnItOnClick$2 */
/* compiled from: NewFeatureDialogPresenter.kt */
final class NewFeatureDialogPresenter$handleTurnItOnClick$2<T, R> implements C5379n<T, C5368e<? extends R>> {
    final /* synthetic */ NewFeatureDialogPresenter this$0;

    NewFeatureDialogPresenter$handleTurnItOnClick$2(NewFeatureDialogPresenter newFeatureDialogPresenter) {
        this.this$0 = newFeatureDialogPresenter;
    }

    public final C5368e<Void> call(View.LifecycleEvent lifecycleEvent) {
        return this.this$0.getView().clickTurnItOn();
    }
}
