...
/* renamed from: cm.aptoide.pt.feature.NewFeatureDialogPresenter$handleDismissClick$3 */
/* compiled from: NewFeatureDialogPresenter.kt */
final class NewFeatureDialogPresenter$handleDismissClick$3<T> implements C5378b<Void> {
    final /* synthetic */ NewFeatureDialogPresenter this$0;

    NewFeatureDialogPresenter$handleDismissClick$3(NewFeatureDialogPresenter newFeatureDialogPresenter) {
        this.this$0 = newFeatureDialogPresenter;
    }

    public final void call(Void voidR) {
        this.this$0.getView().dismissView();
        this.this$0.newFeatureListener.onDismiss();
    }
}
