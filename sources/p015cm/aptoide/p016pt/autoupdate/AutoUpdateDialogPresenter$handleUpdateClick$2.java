...
/* renamed from: cm.aptoide.pt.autoupdate.AutoUpdateDialogPresenter$handleUpdateClick$2 */
/* compiled from: AutoUpdateDialogPresenter.kt */
final class AutoUpdateDialogPresenter$handleUpdateClick$2<T, R> implements C5379n<T, C5368e<? extends R>> {
    final /* synthetic */ AutoUpdateDialogPresenter this$0;

    AutoUpdateDialogPresenter$handleUpdateClick$2(AutoUpdateDialogPresenter autoUpdateDialogPresenter) {
        this.this$0 = autoUpdateDialogPresenter;
    }

    public final C5368e<Void> call(View.LifecycleEvent lifecycleEvent) {
        return this.this$0.view.updateClicked();
    }
}
