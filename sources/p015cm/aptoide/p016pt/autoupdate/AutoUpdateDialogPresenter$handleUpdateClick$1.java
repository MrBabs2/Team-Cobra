...
/* renamed from: cm.aptoide.pt.autoupdate.AutoUpdateDialogPresenter$handleUpdateClick$1 */
/* compiled from: AutoUpdateDialogPresenter.kt */
final class AutoUpdateDialogPresenter$handleUpdateClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final AutoUpdateDialogPresenter$handleUpdateClick$1 INSTANCE = new AutoUpdateDialogPresenter$handleUpdateClick$1();

    AutoUpdateDialogPresenter$handleUpdateClick$1() {
    }
