...
/* renamed from: cm.aptoide.pt.search.SearchRepository$searchInStore$1 */
/* compiled from: SearchRepository.kt */
final class SearchRepository$searchInStore$1<T, R> implements C5379n<String, C5328b> {
    ...
    SearchRepository$searchInStore$1(SearchRepository searchRepository, String str, SearchFilters searchFilters, boolean z, String str2, boolean z2) {
    ...
    public final C5328b call(String str) {
        return this.this$0.search(this.$query, this.$filters, this.$matureEnabled, this.$storeName, this.$useCachedValues);
    }
}
