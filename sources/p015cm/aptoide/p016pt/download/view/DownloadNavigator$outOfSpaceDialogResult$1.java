...
/* renamed from: cm.aptoide.pt.download.view.DownloadNavigator$outOfSpaceDialogResult$1 */
/* compiled from: DownloadNavigator.kt */
final class DownloadNavigator$outOfSpaceDialogResult$1<T, R> implements C5379n<T, R> {
    public static final DownloadNavigator$outOfSpaceDialogResult$1 INSTANCE = new DownloadNavigator$outOfSpaceDialogResult$1();

    DownloadNavigator$outOfSpaceDialogResult$1() {
    }
