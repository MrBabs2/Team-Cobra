...
/* renamed from: cm.aptoide.pt.download.view.outofspace.OutOfSpaceDialogPresenter$loadAppsToUninstall$1 */
/* compiled from: OutOfSpaceDialogPresenter.kt */
final class OutOfSpaceDialogPresenter$loadAppsToUninstall$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final OutOfSpaceDialogPresenter$loadAppsToUninstall$1 INSTANCE = new OutOfSpaceDialogPresenter$loadAppsToUninstall$1();

    OutOfSpaceDialogPresenter$loadAppsToUninstall$1() {
    }
