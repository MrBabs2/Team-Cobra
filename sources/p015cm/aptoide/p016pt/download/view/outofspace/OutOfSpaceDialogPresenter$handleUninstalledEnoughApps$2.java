...
/* renamed from: cm.aptoide.pt.download.view.outofspace.OutOfSpaceDialogPresenter$handleUninstalledEnoughApps$2 */
/* compiled from: OutOfSpaceDialogPresenter.kt */
final class OutOfSpaceDialogPresenter$handleUninstalledEnoughApps$2<T, R> implements C5379n<T, C5368e<? extends R>> {
    final /* synthetic */ OutOfSpaceDialogPresenter this$0;

    OutOfSpaceDialogPresenter$handleUninstalledEnoughApps$2(OutOfSpaceDialogPresenter outOfSpaceDialogPresenter) {
        this.this$0 = outOfSpaceDialogPresenter;
    }

    public final C5368e<Void> call(View.LifecycleEvent lifecycleEvent) {
        return this.this$0.outOfSpaceManager.uninstalledEnoughApps();
    }
}
