...
/* renamed from: cm.aptoide.pt.download.view.outofspace.OutOfSpaceDialogPresenter$uninstallApp$1 */
/* compiled from: OutOfSpaceDialogPresenter.kt */
final class OutOfSpaceDialogPresenter$uninstallApp$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final OutOfSpaceDialogPresenter$uninstallApp$1 INSTANCE = new OutOfSpaceDialogPresenter$uninstallApp$1();

    OutOfSpaceDialogPresenter$uninstallApp$1() {
    }
