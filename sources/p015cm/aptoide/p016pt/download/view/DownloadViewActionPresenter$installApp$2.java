...
/* renamed from: cm.aptoide.pt.download.view.DownloadViewActionPresenter$installApp$2 */
/* compiled from: DownloadViewActionPresenter.kt */
final class DownloadViewActionPresenter$installApp$2<T, R> implements C5379n<WalletAdsOfferManager.OfferResponseStatus, C5328b> {
    final /* synthetic */ DownloadClick $downloadClick;
    final /* synthetic */ DownloadViewActionPresenter this$0;

    DownloadViewActionPresenter$installApp$2(DownloadViewActionPresenter downloadViewActionPresenter, DownloadClick downloadClick) {
    ...
    public final C5328b call(WalletAdsOfferManager.OfferResponseStatus offerResponseStatus) {
        ...
        return downloadViewActionPresenter.downgradeApp(download, offerResponseStatus);
    }
}
