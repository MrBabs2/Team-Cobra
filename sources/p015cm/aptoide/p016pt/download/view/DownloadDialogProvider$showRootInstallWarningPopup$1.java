...
/* renamed from: cm.aptoide.pt.download.view.DownloadDialogProvider$showRootInstallWarningPopup$1 */
/* compiled from: DownloadDialogProvider.kt */
final class DownloadDialogProvider$showRootInstallWarningPopup$1<T, R> implements C5379n<T, R> {
    public static final DownloadDialogProvider$showRootInstallWarningPopup$1 INSTANCE = new DownloadDialogProvider$showRootInstallWarningPopup$1();

    DownloadDialogProvider$showRootInstallWarningPopup$1() {
    }
