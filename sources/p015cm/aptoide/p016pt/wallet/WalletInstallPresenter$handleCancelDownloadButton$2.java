...
final class WalletInstallPresenter$handleCancelDownloadButton$2<T, R> implements C5379n<T, C5368e<? extends R>> {
    ...
    public final C5368e<Void> call(View.LifecycleEvent lifecycleEvent) {
        return this.this$0.getView().cancelDownloadButtonClicked();
    }
}
