...
/* renamed from: cm.aptoide.pt.wallet.WalletInstallPresenter$handleCloseButtonClick$1 */
/* compiled from: WalletInstallPresenter.kt */
final class WalletInstallPresenter$handleCloseButtonClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final WalletInstallPresenter$handleCloseButtonClick$1 INSTANCE = new WalletInstallPresenter$handleCloseButtonClick$1();

    WalletInstallPresenter$handleCloseButtonClick$1() {
    }
