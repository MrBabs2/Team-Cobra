...
@C4789l(mo16639bv = {1, 0, 3}, mo16640d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012*\u0010\u0002\u001a&\u0012\u0006\u0012\u0004\u0018\u00010\u0004\u0012\u0004\u0012\u00020\u0005 \u0006*\u0012\u0012\u0006\u0012\u0004\u0018\u00010\u0004\u0012\u0004\u0012\u00020\u0005\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0007"}, mo16641d2 = {"<anonymous>", "", "pair", "Lkotlin/Pair;", "", "Lcm/aptoide/pt/promotions/WalletApp;", "kotlin.jvm.PlatformType", "call"}, mo16642k = 3, mo16643mv = {1, 1, 16})
/* renamed from: cm.aptoide.pt.wallet.WalletInstallPresenter$showWalletInitialState$2 */
/* compiled from: WalletInstallPresenter.kt */
final class WalletInstallPresenter$showWalletInitialState$2<T> implements C5378b<C10221n<? extends String, ? extends WalletApp>> {
    ...
    public final void call(C10221n<String, WalletApp> nVar) {
        if (nVar.mo35392d().isInstalled()) {
            this.this$0.getView().showWalletInstalledAlreadyView();
        } else {
            this.this$0.getView().showWalletInstallationView(nVar.mo35391c(), nVar.mo35392d());
        }
    }
}
