...
/* renamed from: cm.aptoide.pt.wallet.WalletInstallManager$resumeDownload$1 */
/* compiled from: WalletInstallManager.kt */
final class WalletInstallManager$resumeDownload$1<T, R> implements C5379n<T, Single<? extends R>> {
    final /* synthetic */ WalletApp $app;
    final /* synthetic */ WalletInstallManager this$0;

    WalletInstallManager$resumeDownload$1(WalletInstallManager walletInstallManager, WalletApp walletApp) {
    ...
    public final Single<RoomDownload> call(final RoomDownload roomDownload) {
        return this.this$0.getMoPubAdsManager().getAdsVisibilityStatus().mo18564b(new C5378b<WalletAdsOfferManager.OfferResponseStatus>(this) {
            final /* synthetic */ WalletInstallManager$resumeDownload$1 this$0;
            ...
            public final void call(WalletAdsOfferManager.OfferResponseStatus offerResponseStatus) {
                ...
                long id = this.this$0.$app.getId();
                C10202j.m34174a((Object) offerResponseStatus, "responseStatus");
                walletInstallManager.setupDownloadEvents(roomDownload, action, id, offerResponseStatus, this.this$0.$app.getPackageName(), this.this$0.$app.getDeveloper());
            }
