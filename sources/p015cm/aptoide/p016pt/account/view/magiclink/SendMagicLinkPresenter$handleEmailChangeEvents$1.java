...
/* renamed from: cm.aptoide.pt.account.view.magiclink.SendMagicLinkPresenter$handleEmailChangeEvents$1 */
/* compiled from: SendMagicLinkPresenter.kt */
final class SendMagicLinkPresenter$handleEmailChangeEvents$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final SendMagicLinkPresenter$handleEmailChangeEvents$1 INSTANCE = new SendMagicLinkPresenter$handleEmailChangeEvents$1();

    SendMagicLinkPresenter$handleEmailChangeEvents$1() {
    }
