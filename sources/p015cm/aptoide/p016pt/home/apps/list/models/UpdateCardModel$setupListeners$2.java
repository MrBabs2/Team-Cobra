...
/* renamed from: cm.aptoide.pt.home.apps.list.models.UpdateCardModel$setupListeners$2 */
/* compiled from: UpdateCardModel.kt */
final class UpdateCardModel$setupListeners$2 implements View.OnClickListener {
    final /* synthetic */ UpdateApp $app;
    final /* synthetic */ UpdateCardModel this$0;

    UpdateCardModel$setupListeners$2(UpdateCardModel updateCardModel, UpdateApp updateApp) {
    ...
    public final void onClick(View view) {
        ...
        if (eventSubject != null) {
            eventSubject.onNext(new AppClick(this.$app, AppClick.ClickType.CARD_CLICK));
        }
    }
}
