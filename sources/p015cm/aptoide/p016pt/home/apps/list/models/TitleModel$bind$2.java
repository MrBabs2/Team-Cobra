...
/* renamed from: cm.aptoide.pt.home.apps.list.models.TitleModel$bind$2 */
/* compiled from: TitleModel.kt */
final class TitleModel$bind$2 implements View.OnClickListener {
    final /* synthetic */ TitleModel this$0;

    TitleModel$bind$2(TitleModel titleModel) {
        this.this$0 = titleModel;
    }

    public final void onClick(View view) {
        C12871b<Void> eventSubject = this.this$0.getEventSubject();
