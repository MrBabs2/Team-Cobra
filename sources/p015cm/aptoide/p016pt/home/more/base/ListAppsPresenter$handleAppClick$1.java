...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleAppClick$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleAppClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$handleAppClick$1 INSTANCE = new ListAppsPresenter$handleAppClick$1();

    ListAppsPresenter$handleAppClick$1() {
    }
