...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleRefreshSwipe$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleRefreshSwipe$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$handleRefreshSwipe$1 INSTANCE = new ListAppsPresenter$handleRefreshSwipe$1();

    ListAppsPresenter$handleRefreshSwipe$1() {
    }
