...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleRetryClick$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleRetryClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$handleRetryClick$1 INSTANCE = new ListAppsPresenter$handleRetryClick$1();

    ListAppsPresenter$handleRetryClick$1() {
    }
