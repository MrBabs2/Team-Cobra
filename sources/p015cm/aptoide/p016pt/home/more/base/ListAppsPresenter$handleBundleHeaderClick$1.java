...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleBundleHeaderClick$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleBundleHeaderClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$handleBundleHeaderClick$1 INSTANCE = new ListAppsPresenter$handleBundleHeaderClick$1();

    ListAppsPresenter$handleBundleHeaderClick$1() {
    }
