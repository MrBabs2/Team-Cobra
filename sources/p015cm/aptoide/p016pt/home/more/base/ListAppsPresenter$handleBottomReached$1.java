...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleBottomReached$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleBottomReached$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$handleBottomReached$1 INSTANCE = new ListAppsPresenter$handleBottomReached$1();

    ListAppsPresenter$handleBottomReached$1() {
    }
