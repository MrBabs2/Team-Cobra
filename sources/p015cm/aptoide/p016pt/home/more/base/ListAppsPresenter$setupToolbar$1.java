...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$setupToolbar$1 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$setupToolbar$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final ListAppsPresenter$setupToolbar$1 INSTANCE = new ListAppsPresenter$setupToolbar$1();

    ListAppsPresenter$setupToolbar$1() {
    }
