...
/* renamed from: cm.aptoide.pt.home.more.base.ListAppsPresenter$handleRefreshSwipe$2 */
/* compiled from: ListAppsPresenter.kt */
final class ListAppsPresenter$handleRefreshSwipe$2<T, R> implements C5379n<T, C5368e<? extends R>> {
    final /* synthetic */ ListAppsPresenter this$0;

    ListAppsPresenter$handleRefreshSwipe$2(ListAppsPresenter listAppsPresenter) {
        this.this$0 = listAppsPresenter;
    }

    public final C5368e<List<T>> call(View.LifecycleEvent lifecycleEvent) {
        return this.this$0.view.refreshEvents().mo18687f(new C5379n<T, C5368e<? extends R>>(this) {
            final /* synthetic */ ListAppsPresenter$handleRefreshSwipe$2 this$0;
