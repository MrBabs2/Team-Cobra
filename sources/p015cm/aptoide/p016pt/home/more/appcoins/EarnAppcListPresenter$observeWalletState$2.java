...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$observeWalletState$2 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$observeWalletState$2<T> implements C5378b<WalletApp> {
    final /* synthetic */ EarnAppcListPresenter this$0;

    EarnAppcListPresenter$observeWalletState$2(EarnAppcListPresenter earnAppcListPresenter) {
    ...
    public final void call(WalletApp walletApp) {
        ...
        access$getView$p.updateState(walletApp);
    }
}
