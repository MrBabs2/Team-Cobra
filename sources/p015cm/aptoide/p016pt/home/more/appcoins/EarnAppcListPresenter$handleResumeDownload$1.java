...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$handleResumeDownload$1 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$handleResumeDownload$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final EarnAppcListPresenter$handleResumeDownload$1 INSTANCE = new EarnAppcListPresenter$handleResumeDownload$1();

    EarnAppcListPresenter$handleResumeDownload$1() {
    }
