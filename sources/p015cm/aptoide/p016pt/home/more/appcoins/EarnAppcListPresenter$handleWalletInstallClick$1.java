...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$handleWalletInstallClick$1 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$handleWalletInstallClick$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final EarnAppcListPresenter$handleWalletInstallClick$1 INSTANCE = new EarnAppcListPresenter$handleWalletInstallClick$1();

    EarnAppcListPresenter$handleWalletInstallClick$1() {
    }
