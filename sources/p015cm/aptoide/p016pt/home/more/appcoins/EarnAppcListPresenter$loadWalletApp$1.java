...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$loadWalletApp$1 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$loadWalletApp$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final EarnAppcListPresenter$loadWalletApp$1 INSTANCE = new EarnAppcListPresenter$loadWalletApp$1();

    EarnAppcListPresenter$loadWalletApp$1() {
    }
