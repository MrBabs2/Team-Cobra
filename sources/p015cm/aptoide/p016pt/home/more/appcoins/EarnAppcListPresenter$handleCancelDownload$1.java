...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$handleCancelDownload$1 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$handleCancelDownload$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final EarnAppcListPresenter$handleCancelDownload$1 INSTANCE = new EarnAppcListPresenter$handleCancelDownload$1();

    EarnAppcListPresenter$handleCancelDownload$1() {
    }
