...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListManager$downloadApp$1 */
/* compiled from: EarnAppcListManager.kt */
final class EarnAppcListManager$downloadApp$1<T, R> implements C5379n<WalletApp, C5328b> {
    final /* synthetic */ EarnAppcListManager this$0;

    EarnAppcListManager$downloadApp$1(EarnAppcListManager earnAppcListManager) {
    ...
    public final C5328b call(WalletApp walletApp) {
        ...
        return access$getWalletInstallManager$p.downloadApp(walletApp);
    }
}
