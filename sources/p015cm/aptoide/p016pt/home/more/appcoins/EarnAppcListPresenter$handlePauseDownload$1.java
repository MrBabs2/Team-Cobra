...
/* renamed from: cm.aptoide.pt.home.more.appcoins.EarnAppcListPresenter$handlePauseDownload$1 */
/* compiled from: EarnAppcListPresenter.kt */
final class EarnAppcListPresenter$handlePauseDownload$1<T, R> implements C5379n<View.LifecycleEvent, Boolean> {
    public static final EarnAppcListPresenter$handlePauseDownload$1 INSTANCE = new EarnAppcListPresenter$handlePauseDownload$1();

    EarnAppcListPresenter$handlePauseDownload$1() {
    }
