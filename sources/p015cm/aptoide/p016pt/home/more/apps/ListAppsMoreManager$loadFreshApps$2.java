...
/* renamed from: cm.aptoide.pt.home.more.apps.ListAppsMoreManager$loadFreshApps$2 */
/* compiled from: ListAppsMoreManager.kt */
final class ListAppsMoreManager$loadFreshApps$2<T, R> implements C5379n<T, R> {
    final /* synthetic */ ListAppsMoreManager this$0;

    ListAppsMoreManager$loadFreshApps$2(ListAppsMoreManager listAppsMoreManager) {
    ...
    public final List<Application> call(ListApps listApps) {
        ...
        return listAppsMoreManager.mapEskillsResponse(listApps);
    }
}
