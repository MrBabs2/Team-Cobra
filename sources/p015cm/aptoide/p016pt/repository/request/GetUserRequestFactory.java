...
public class GetUserRequestFactory {
    ...
    public GetUserRequest newGetUser(String str, boolean z) {
        return GetUserRequest.m5374of(str, this.storeCredentialsProvider.fromUrl(str), this.bodyInterceptor, this.httpClient, this.converterFactory, this.tokenInvalidator, this.sharedPreferences, this.resources, this.windowManager, this.clientUniqueId, z, this.partnerId, this.accountManager.hasMatureContentEnabled().mo18669c().mo18700m().mo18562a().mo41082a().booleanValue(), this.filters, this.systemService, this.versionCodeProvider, this.appBundlesVisibilityManager, this.appCoinsManager);
    }
}
