...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            C9064d dVar = objArr[objArr.length - 1];
            try {
                if (this.isNullable) {
                    return KotlinExtensions.awaitNullable(call2, dVar);
                }
                return KotlinExtensions.await(call2, dVar);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, dVar);
            }
        }
    }
