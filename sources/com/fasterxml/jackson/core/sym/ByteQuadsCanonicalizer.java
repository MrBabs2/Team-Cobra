...
public final class ByteQuadsCanonicalizer {
    ...
    private int _appendLongName(int[] iArr, int i) {
        ...
        if (i3 > iArr2.length) {
            this._hashArea = Arrays.copyOf(this._hashArea, this._hashArea.length + Math.max(i3 - iArr2.length, Math.min(RecyclerView.C0638l.FLAG_APPEARED_IN_PRE_LAYOUT, this._hashSize)));
        }
