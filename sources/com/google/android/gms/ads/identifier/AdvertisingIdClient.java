...
public class AdvertisingIdClient {
    ...
    private static BlockingServiceConnection zza(Context context, boolean z) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
            ...
            if (a == 0 || a == 2) {
                ...
                try {
                    if (ConnectionTracker.m16228a().mo25487a(context, intent, blockingServiceConnection, 1)) {
    ...
    private static zze zza(Context context, BlockingServiceConnection blockingServiceConnection) throws IOException {
        try {
            return zzf.m25772a(blockingServiceConnection.mo24836a(10000, TimeUnit.MILLISECONDS));
        } catch (InterruptedException unused) {
    ...
    private final void zza(boolean z) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        Preconditions.m16050c("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.zzg) {
                finish();
            }
    ...
    private final boolean zzb() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m16037a(this.zze);
            Preconditions.m16037a(this.zzf);
            g = this.zzf.mo29930g();
        }
        zza();
        return g;
    ...
    public final void finish() {
        /*
            ...
            com.google.android.gms.common.internal.Preconditions.m16050c(r0)
            monitor-enter(r3)
        ...
        L_0x000f:
            ...
            com.google.android.gms.common.stats.ConnectionTracker r0 = com.google.android.gms.common.stats.ConnectionTracker.m16228a()     // Catch:{ all -> 0x001f }
            ...
            r0.mo25486a(r1, r2)     // Catch:{ all -> 0x001f }
            goto L_0x0027
        L_0x001f:
            r0 = move-exception
    ...
    public Info getInfo() throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m16037a(this.zze);
            Preconditions.m16037a(this.zzf);
            info = new Info(this.zzf.getId(), this.zzf.mo29932i(true));
        }
        zza();
        return info;
    }
