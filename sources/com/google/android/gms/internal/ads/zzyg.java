...
import com.google.android.gms.ads.C7124R;

@zzard
public final class zzyg {

    /* renamed from: a */
    private final AdSize[] f23027a;

    /* renamed from: b */
    private final String f23028b;

    public zzyg(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C7124R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C7124R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C7124R.styleable.AdsAttrs_adSizes);
        boolean z = !TextUtils.isEmpty(string);
        boolean z2 = !TextUtils.isEmpty(string2);
        if (z && !z2) {
            this.f23027a = m25649a(string);
        } else if (!z && z2) {
            this.f23027a = m25649a(string2);
        } else if (z) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        String string3 = obtainAttributes.getString(C7124R.styleable.AdsAttrs_adUnitId);
    ...
    /* renamed from: a */
    private static AdSize[] m25649a(String str) {
        int i;
        int i2;
    ...
    /* renamed from: a */
    public final AdSize[] mo29915a(boolean z) {
        if (z || this.f23027a.length == 1) {
            return this.f23027a;
        }
