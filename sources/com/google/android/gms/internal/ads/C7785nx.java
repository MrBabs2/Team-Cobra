...
abstract class C7785nx {
    C7785nx() {
    }

    /* renamed from: b */
    static void m17708b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo26325a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract int mo26326a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public abstract void mo26327a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final boolean mo26328a(byte[] bArr, int i, int i2) {
        return mo26325a(0, bArr, i, i2) == 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public abstract String mo26329b(byte[] bArr, int i, int i2) throws zzdok;
}
