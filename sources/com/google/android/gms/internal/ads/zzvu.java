...
public final class zzvu extends zzc<zzvy> {
    zzvu(Context context, Looper looper, BaseGmsClient.BaseConnectionCallbacks baseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener baseOnConnectionFailedListener) {
        super(zzasq.m19919c(context), looper, 123, baseConnectionCallbacks, baseOnConnectionFailedListener, (String) null);
    }

    /* renamed from: c */
    public final zzvy mo29850c() throws DeadObjectException {
