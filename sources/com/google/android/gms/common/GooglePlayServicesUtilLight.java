...
public class GooglePlayServicesUtilLight {
    ...
    public static void ensurePlayServicesAvailable(Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int a = GoogleApiAvailabilityLight.m15275a().mo24858a(context, i);
        if (a != 0) {
            Intent a2 = GoogleApiAvailabilityLight.m15275a().mo24863a(context, a, "e");
    ...
    public static int getClientVersion(Context context) {
        Preconditions.m16047b(true);
        return ClientLibraryUtils.m16250a(context, context.getPackageName());
    }

    @KeepForSdk
    @Deprecated
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        return GoogleApiAvailabilityLight.m15275a().mo24861a(context, i, i2);
    }
    ...
    public static String getErrorString(int i) {
        return ConnectionResult.m15244a(i);
    }
    ...
    public static Intent getGooglePlayServicesAvailabilityRecoveryIntent(int i) {
        return GoogleApiAvailabilityLight.m15275a().mo24863a((Context) null, i, (String) null);
    }
    ...
    public static boolean honorsDebugCertificates(Context context) {
        if (!zzak) {
            try {
                PackageInfo b = Wrappers.m16317a(context).mo25510b("com.google.android.gms", 64);
                GoogleSignatureVerifier.m15289a(context);
                if (b == null || GoogleSignatureVerifier.m15291a(b, false) || !GoogleSignatureVerifier.m15291a(b, true)) {
                    zzaj = false;
                } else {
                    zzaj = true;
                }
        ...
        return zzaj || !DeviceProperties.m16269a();
    }
    ...
    public static boolean isGooglePlayServicesUid(Context context, int i) {
        return UidVerifier.m16298a(context, i);
    }
    ...
    public static boolean isRestrictedUserProfile(android.content.Context r1) {
        /*
            boolean r0 = com.google.android.gms.common.util.PlatformVersion.m16289e()
    ...
    public static boolean isSidewinderDevice(Context context) {
        return DeviceProperties.m16271b(context);
    }
    ...
    public static boolean uidHasPackageName(Context context, int i, String str) {
        return UidVerifier.m16299a(context, i, str);
    }

    @VisibleForTesting
    private static int zza(Context context, boolean z, int i) {
        Preconditions.m16043a(i >= 0);
        ...
        try {
            ...
            GoogleSignatureVerifier.m15289a(context);
            if (!GoogleSignatureVerifier.m15291a(packageInfo2, true)) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            } else if (z && (!GoogleSignatureVerifier.m15291a(packageInfo, true) || !packageInfo.signatures[0].equals(packageInfo2.signatures[0]))) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            } else if (zzb.m16307a(packageInfo2.versionCode) < zzb.m16307a(i)) {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C7158R.string.common_google_play_services_unknown_issue);
        } catch (Throwable unused) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzal.get()) {
            int b = zzp.m16184b(context);
            if (b == 0) {
        ...
        return zza(context, !DeviceProperties.m16273d(context) && !DeviceProperties.m16274e(context), i);
    }
}
