...
public final class C8836i {
    ...
    /* renamed from: a */
    public static String m28876a(String str, C8838k kVar) {
        if (str.length() == kVar.mo32637a()) {
            StringBuilder sb = new StringBuilder(kVar.mo32637a() + kVar.mo32638b());
            sb.append(str);
            int c = kVar.mo32615c();
            if (c == 1) {
                sb.append(m28874a((CharSequence) str, kVar.mo32638b()));
            } else {
                ...
                while (i < c) {
                    int i2 = i + 1;
                    iArr[i] = kVar.mo32614a(i2);
                    iArr2[i] = kVar.mo32639b(i2);
                    iArr3[i] = 0;
                    if (i > 0) {
                ...
                for (int i3 = 0; i3 < c; i3++) {
                    ...
                    for (int i4 = i3; i4 < kVar.mo32637a(); i4 += c) {
                        sb2.append(str.charAt(i4));
                    }
                    String a = m28874a((CharSequence) sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
                    while (i5 < iArr2[i3] * c) {
                        sb.setCharAt(kVar.mo32637a() + i5, a.charAt(i6));
                        i5 += c;
                        i6++;
                    }
                }
    ...
    /* renamed from: a */
    private static String m28874a(CharSequence charSequence, int i) {
        return m28875a(charSequence, 0, charSequence.length(), i);
    }

    /* renamed from: a */
    private static String m28875a(CharSequence charSequence, int i, int i2, int i3) {
        int i4 = 0;
        while (true) {
            int[] iArr = f25103a;
            if (i4 >= iArr.length) {
